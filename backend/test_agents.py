...
def test_data_loader():
    ...
    try:
        ...
        patients = loader.generate_synthetic_patients(n=10)
        logger.info(f"✓ Generated {len(patients)} synthetic patients")

        trials = loader.generate_synthetic_trials(condition="diabetes", num_trials=5)
...
def test_conway_engine():
    ...
    try:
        ...
        # Generate small test dataset
        loader = ClinicalDataLoader()
        data = loader.prepare_for_conway(num_patients=100, num_trials=10)
